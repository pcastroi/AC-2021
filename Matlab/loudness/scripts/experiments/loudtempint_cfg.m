...
def=struct(...
'expname','loudtempint',		...		% name of experiment   
...
'exppar1',[10 20 40 80 160 320 640],				...		% vector containing experimental parameters for which the exp is performed
'exppar1unit','Duration/ms',		...		% unit of experimental parameter
...
'messages','loudtempint',	...		% message configuration file
