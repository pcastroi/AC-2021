...
def=struct(...
'expname','loudadj',		...		% name of experiment   
...
'startvar',0,			...		% starting value of the tracking variable
...
'exppar1',[0.5 2],				...		% vector containing experimental parameters for which the exp is performed
'exppar1unit','Loud re ref',		...		% unit of experimental parameter
...
'messages','loudadj',	...		% message configuration file
