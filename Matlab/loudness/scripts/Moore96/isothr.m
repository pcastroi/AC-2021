...
% function [vIsoThrDB, vsF] = isothr(vsDesF);
%
% returns the Iso Threshold along the frequency
% scale 'vsDesF' or at audiometric frequencies.
%
% vsDesF   : Desired frequency scale (optional).
% vIsoThrdB: Threshold in DB SPL for tones (ISO226) 
% vsF      : corresponding frequency scale
%
...
if nargin > 0,
	vIsoThrDB = interp1(vsF,vThr,vsDesF,'linear');
	vF = vsDesF;
else,
	vIsoThrDB = vThr;
end;
